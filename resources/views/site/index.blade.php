...
<head>
    ...
    -->
    <meta charset="UTF-8">
    <title>Home page 01 - Consulting html5 templates</title>
    ...
    <link href='https://fonts.googleapis.com/css?family=Roboto:400,100,300,400italic,500italic,500,700,900' rel='stylesheet' type='text/css'>
...
<body>
            ...
            <div class="relative">
                ...
                <div class="owl-carousel nav-style-1" data-carousel-margin="45" data-carousel-nav="true" data-carousel-loop="true">
                    <div class="image-card image-card-1 light">
                        <div class="image">
                            <a href="blog-single.html">
                                <img src="images/services-01.jpg" alt="Corporate Finance" />
                            </a>
                        </div>
                        <h3 class="title">
                            <a href="blog-single.html">Corporate Finance</a>
                        </h3>
                        <div class="content">
                    ...
                    <div class="image-card image-card-1 light">
                        ...
                        <h3 class="title">
                            <a href="blog-single.html">Strategy Consulting</a>
                        </h3>
                        <div class="content">
                            <p>Phasellus lorem enim, luctus ut velit eget, convallis egestas eros. Sed ornare ligula eget tortor tempor, quis porta tellus dictum.</p>
                        </div>
                    ...
                    <div class="image-card image-card-1 light">
                        ...
                        <h3 class="title">
                            <a href="blog-single.html">Tax Planning</a>
                        </h3>
                        <div class="content">
                            <p>Phasellus lorem enim, luctus ut velit eget, convallis egestas eros. Sed ornare ligula eget tortor tempor, quis porta tellus dictum.</p>
                        </div>
                    ...
                    <div class="image-card image-card-1 light">
                        <div class="image">
                            <a href="blog-single.html">
                                <img src="images/services-05.jpg" alt="Private Equity Consulting" />
                            </a>
                        </div>
                        <h3 class="title">
                            <a href="blog-single.html">Private Equity Consulting</a>
                        </h3>
                        <div class="content">
                            <p>Phasellus lorem enim, luctus ut velit eget, convallis egestas eros. Sed ornare ligula eget tortor tempor, quis porta tellus dictum.</p>
                        </div>
                    ...
                    <div class="image-card image-card-1 light">
                        <div class="image">
                            <a href="blog-single.html">
                                <img src="images/services-09.jpg" alt="Business Consulting" />
                            </a>
                        </div>
                        <h3 class="title">
                            <a href="blog-single.html">Business Consulting</a>
                        </h3>
                        <div class="content">
                            <p>Phasellus lorem enim, luctus ut velit eget, convallis egestas eros. Sed ornare ligula eget tortor tempor, quis porta tellus dictum.</p>
                        </div>
                    ...
                    <div class="image-card image-card-1 light">
                        <div class="image">
                            <a href="blog-single.html">
                                <img src="images/services-08.jpg" alt="Financial Services Consulting" />
                            </a>
                        </div>
                        <h3 class="title">
                            <a href="blog-single.html">Financial Services Consulting</a>
                        </h3>
                        <div class="content">
                            <p>Phasellus lorem enim, luctus ut velit eget, convallis egestas eros. Sed ornare ligula eget tortor tempor, quis porta tellus dictum.</p>
                        </div>
                    ...
                    <div class="image-card image-card-1 light">
                        <div class="image">
                            <a href="blog-single.html">
                                <img src="images/services-07.jpg" alt="Consumer Products Consulting" />
                            </a>
                        </div>
                        <h3 class="title">
                            <a href="blog-single.html">Consumer Products Consulting</a>
                        </h3>
                        <div class="content">
                            <p>Phasellus lorem enim, luctus ut velit eget, convallis egestas eros. Sed ornare ligula eget tortor tempor, quis porta tellus dictum.</p>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p class="text-block m-b-25">Who we are, how we work, our priorities and our values. Phasellus mauris arcu, facilisis vel velit vitae, tincidunt scelerisque mauris. Phasellus placerat elementum ornare. Cras scelerisque eu metus tincidunt euismod.</p>
                    ...
                    <div class="progress-box progress-box-1 m-b-25">
                        <p class="progress-label">OPPORTUNITY</p>
                        <div class="au-progress au-progress-1">
                    ...
                    <div class="progress-box progress-box-1">
                        <p class="progress-label">TRANSFORMATION</p>
                        <div class="au-progress au-progress-1">
            ...
            <div class="relative section-testimonials-wrapper-1">
                ...
                <div class="owl-carousel dark nav-style-1" data-carousel-margin="30" data-carousel-nav="true" data-carousel-loop="true" data-carousel-autoplay="true">
                    <div class="image-card image-card-2">
                        ...
                        <div class="card-body">
                            <div class="content">
                                <p>We are lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sapien augue, dictum et gravida et, viverra et est.</p>
                            </div>
                        </div>
                    </div>
                    <div class="image-card image-card-2">
    ...
    <!-- Our Projects / end-->
    <!-- section / start-->
    <div class="section bg-parallax cta-section-4 p-t-120 p-b-120" style="background: url(&quot;images/banner-01.jpg&quot;) no-repeat;" data-paroller-type="background" data-paroller-factor="-0.3" data-paroller-direction="vertical">
        <div class="bg-overlay"></div>
        <div class="container">
    ...
    <div id="switcher">
        ...
        <div class="mCustomScrollbar" data-mcs-theme="minimal-dark">
            <a class="btn-buy" href="https://themeforest.net/cart/add_items?item_ids=20365237&amp;ref=authemes" target="_blank">Buy Now</a>
            ...
            <ul class="demo-homepage">
                ...
                <li>
                    ...
                    <img class="popup-demo-homepage" src="images/home_5.jpg" alt="Image" />
                </li>
                <li>
                    <a href="index5.html">
                        <img src="images/home_6.jpg" alt="" />
                    </a>
                    <img class="popup-demo-homepage" src="images/home_6.jpg" alt="Image" />
                </li>
            </ul>
        </div>
    </div>
